            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="col-span-2 text-right">
                    <button
                        ...
                        class="inline-flex items-center justify-center bg-blue-800 text-blue-200 font-medium text-sm focus:outline-none rounded-sm py-3 px-4 appearance-none leading-normal"
                    >
                        <img
